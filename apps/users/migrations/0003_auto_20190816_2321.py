# Generated by Django 2.2.1 on 2019-08-16 23:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('users', '0002_usersprofile_user_image'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='usersprofile',
            name='user_image',
            field=models.ImageField(blank=True, default='image/default.png', null=True, upload_to='users/images/%Y%m/', verbose_name='头像'),
        ),
        migrations.CreateModel(
            name='Role',
            fields=[
        ...
        migrations.AddField(
            model_name='usersprofile',
            name='department',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.Organization', verbose_name='部门'),
        ),
        migrations.AddField(
            model_name='usersprofile',
            name='roles',
            field=models.ManyToManyField(blank=True, default='guest', to='users.Role', verbose_name='角色'),
        ),
    ]
